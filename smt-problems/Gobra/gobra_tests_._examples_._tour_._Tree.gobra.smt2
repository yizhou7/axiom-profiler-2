(get-info :version)
; (:version "4.12.1")
; Started: 2023-10-31 14:05:24
; Silicon.version: 1.1-SNAPSHOT (46944a65@dspil_symbenchmarking)
; Input file: /home/pcorrect/repos/benchmarking_general/silicon_tests/gobra_tests_._examples_._tour_._Tree.gobra.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
